...
class Service(BaseService):
    def __init__(self, sql_config: dict = None, redis_config: dict = None):
        ...
        super().__init__(self.twitter, self.mihoyobbs, self.pixiv)


class StartService(Service):

    def __init__(self, sql_config: dict = None, redis_config: dict = None):
        super().__init__(sql_config, redis_config)
